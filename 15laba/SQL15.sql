...
insert into teacher values ('МРЗЛ','Мороз Леонарда Станиславовна','ж','ИСиТ');
...
delete from teacher where teacher='МРЗЛ'
...
insert into teacher values ('МРЗЛ','Мороз Леонарда Станиславовна','ж','ИСиТ');
update teacher set teacher='МР' where teacher='МРЗЛ'

delete from teacher where teacher='МРЗЛС'
select * from TR_AUDIT
select * from teacher
...
insert into teacher values ('МРЗЛ','Мороз Леонарда Станиславовна','ж','ИСиТ');
update teacher set teacher='МРЗЛС' where teacher='МРЗЛ'
delete from teacher where teacher='МРЗЛС'
...
select sum(auditorium_capacity) from auditorium --670
...
update AUDITORIUM set AUDITORIUM_CAPACITY=800 where AUDITORIUM='206-1'
